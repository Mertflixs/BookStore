...
-- Örnek veri ekleme
INSERT INTO books (title, isbn, pageCount, publishedDate, thumbnailUrl, shortDescription, longDescription, status, authors, categories, price)
VALUES 
(
    'Unlocking Android',
    '1933988673',
    ...
    'PUBLISH',
    ARRAY['W. Frank Ableson', 'Charlie Collins', 'Robi Sen'],
    ARRAY['Open Source', 'Mobile'],
    30.99
);
